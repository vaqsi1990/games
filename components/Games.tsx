        ...
        <div
          ...
          >
            <div className="relative w-full bg-white/15  border border-white/20 h-[300px] shrink-0">
              <Image src={game.image} alt={game.name} fill className="object-cover transition-transform duration-300 " sizes="250px" />
            </div>
            <p className="p-3 z-12 text-center md:text-5 text-4 font-semibold uppercase text-[#dfe3d8] ">{game.name}</p>
          </div>
        ))}
      </div>
    </section>
